...
public class Ej10 {
    public static void main(String[] args) {
        NotableVAC vac = new NotableVAC(NotableVAC.exponential(0.001));
        System.out.println(vac.inverseProb(Set.GEQ, 0.05));
        NotableVAD vad1 = new NotableVAD(NotableVAD.binomial(5,vac.prob(Set.GEQ,100)));
        System.out.println(vad1.prob(Set.EQ,5));
        NotableVAD vad2 = new NotableVAD(NotableVAD.binomial(5,vac.prob(Set.GEQ,1000)));
